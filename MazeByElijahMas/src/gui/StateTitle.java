...
public class StateTitle extends DefaultState {
	...
	public void start(Controller controller, MazePanel panel) {
		...
		box.setBounds(100, 100, 200, 20);
		box.setBackground(Color.green);
		box.setSelectedIndex(0);
		box.setVisible(true);
		//boxMazeOpts.addActionListener(this);
...
class MazeComboBox extends JPanel implements ActionListener{
	
	public MazeComboBox(MazePanel panel) {
		final String[] mazeTypes = new String[] {"Plain (Falstad)", "Eller", "Prim", "Kruskal"};
		JComboBox boxMazeOpts = new JComboBox(mazeTypes);
		panel.add(boxMazeOpts);
		boxMazeOpts.setVisible(true);
		boxMazeOpts.addActionListener(this);
